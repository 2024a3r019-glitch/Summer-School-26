...
Read ambient light using the LDR and calculate its running average.

Apply hysteresis-based control logic:
...
Display sensor values and actuator states on the LCD.

Publish all sensor readings and device states to the MQTT broker every three seconds.

Print diagnostic information to the Serial Monitor.
